...
**Current version: v0.84.0** — mature, with 253 integration tests and intercepts for 170+ stdlib packages.
...
- `pkg/interpreter/testdata/integration/` - 253 integration test programs
...
```
**Current baseline**: 253 integration + 14 showcase = 267 total (as of v0.84.0)
...
- N new integration test(s) (253 integration + 14 showcase = 267 total).
```
