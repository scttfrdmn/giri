...
**Current version: v0.91.0** — mature, with 260 integration tests and intercepts for 170+ stdlib packages.
...
- `pkg/interpreter/testdata/integration/` - 260 integration test programs
...
### 4. Build & vet clean
```bash
GOEXPERIMENT=arenas go build ./... && GOEXPERIMENT=arenas go vet ./...
```
