...
**Current version: v0.83.0** — mature, with 252 integration tests and intercepts for 170+ stdlib packages.
...
- `pkg/interpreter/testdata/integration/` - 252 integration test programs
...
```
**Current baseline**: 252 integration + 14 showcase = 266 total (as of v0.83.0)
...
- N new integration test(s) (252 integration + 14 showcase = 266 total).
```
