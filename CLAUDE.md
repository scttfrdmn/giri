...
**Current version: v0.82.0** — mature, with 251 integration tests and intercepts for 170+ stdlib packages.
...
- `pkg/interpreter/testdata/integration/` - 251 integration test programs
...
```
**Current baseline**: 251 integration + 14 showcase = 265 total (as of v0.82.0)
...
- N new integration test(s) (251 integration + 14 showcase = 265 total).
```
